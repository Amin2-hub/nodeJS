...
//                             body : 'ghajsdhjhakghjkhj  ahjksdh\n' + 
//                             'fjkalsdjkljfk ajsdk ljaklsdj ka sdjkl'
//                         })
// })
// .then(res => res.json())
...
//수정
fetch('http://localhost:3000/posts/4', {  //경로에는 수정하고자 하는 대상
    method : 'put',
    headers : {
        'content-type' : 'application/json'
    },
    body : JSON.stringify({     //바디에 들어가는건 수정하고자 하는 내용
                            userId : 3,
                            title : 'Hello, World!',
                            body : 'ghajsdhjhakghjkhj  ahjksdh\n' + 
                            'fjkalsdjkljfk ajsdk ljaklsdj ka sdjkl'
